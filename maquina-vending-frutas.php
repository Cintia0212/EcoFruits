...
<body>
    ...
    <section id="tienda" class="section">
		...
		<div id="contenido-producto" class="contenido-producto">
			...
			<h1>Maquina de vending(sumos y frutas)</h1>
			<div class="producto-detalle">
				<img src="img/productos/fruta-deshidradata.jpg" alt="Barrita de Fresa y Pera" class="imagen-producto">
				<div class="descripcion-producto">
					<h2>Descripción del Producto</h2>
					<p>Nuestra máquina expendedora ofrece una selección de frutas frescas y zumos, perfectas<br>
					para mantenerte lleno de energía durante el día.Dotado con 7 bandejas<br>
					para garantizar calidad, sabor y nutrición.</p>

					<div class="codigo-referencia">
						Código de referencia: DUV002	
					</div>
